...
-- 2023-05-29,EBoettger,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_EBoettger')
	 Begin 
	  Alter Database [Assignment07DB_EBoettger] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_EBoettger;
	 End
	Create Database Assignment07DB_EBoettger;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_EBoettger;
...
Select Top 10000000 
	C.CategoryName,
	[InventoryDate] = DateName(mm,i.InventoryDate) + ', ' + DateName(yy,i.InventoryDate),
	[InventoryCountCategory] = Sum(I.[Count])
